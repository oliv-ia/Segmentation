...
def main():
    ...
    adrian_PLIC_path = '/Users/olivia/Documents/PhD/MISTIE/mask_data/PLIC_mask_adrian.npz'
    paul_PLIC_path = '/Users/olivia/Documents/PhD/MISTIE/mask_data/PLIC_mask_paul.npz'
    sacha_PLIC_path = '/Users/olivia/Documents/PhD/MISTIE/mask_data/PLIC_mask_sacha.npz'
    h_PLIC_path = '/Users/olivia/Documents/PhD/MISTIE/mask_data/PLIC_mask_h.npz'
    ...
    # slice analysis
    total_percentage, percentage = GetSliceOverlap4(new_mask_paul,new_id_paul,new_mask_adrian,new_id_adrian,new_mask_sacha,new_id_sacha, new_mask_h, new_id_h)
    ...
    h_df = pd.DataFrame(dice_array_h, columns = ["Dice 1", "Dice 2", "Dice 3"], index = staple_ids)
    #sacha_df.insert(0, "Patient_ID", new_id_sacha, True)
    ...
    area_flat_h =[]
    dice_flat_h =[]
    for i in range(0, len(areas_h)):
        for j in range(0, len(areas_h[i])):
