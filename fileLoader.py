...
def main():
    ...
    adrian_df = pd.DataFrame(dice_array_adrian, columns = ["Dice 1", "Dice 2", "Dice 3", "Dice 4" ,"Dice 5" , "Dice 6"] , index = staple_ids)
    ...
    paul_df = pd.DataFrame(dice_array_paul, columns = ["Dice 1", "Dice 2", "Dice 3", "Dice 4", "Dice 5", "Dice 6"], index = staple_ids)
    ...
    sacha_df = pd.DataFrame(dice_array_sacha, columns = ["Dice 1", "Dice 2", "Dice 3", "Dice 4" ,"Dice 5", "Dice 6"], index = staple_ids)
    #sacha_df.insert(0, "Patient_ID", new_id_sacha, True)
    sacha_df["Average Dice"] = sacha_patient_avg
    sacha_df.index.name = "Patient ID"


    total_df = pd.DataFrame([adrian_total_avg, paul_total_avg, sacha_total_avg], index =["Adrian average Dice","Paul average Dice", "Sacha average Dice"] )
